...
import { Users, Banknote, AreaChart, Target, Rocket } from "lucide-react";

// Define your data in an array
const whoIsThisForData = [
  {
    icon: <Users className="h-6 w-6 text-cyan-400" />,
    text: "Are a Student or Fresher aiming to stand out in internships or job applications.",
  },
  {
    icon: <Banknote className="h-6 w-6 text-cyan-400" />,
    text: "Are a Working Professional looking to automate tasks, streamline reports, or build dashboards.",
  },
  {
    icon: <AreaChart className="h-6 w-6 text-cyan-400" />,
    text: "Are a Job Seeker or Career Switcher preparing for Analyst, MIS, or Data roles.",
  },
  {
    icon: <Target className="h-6 w-6 text-cyan-400" />,
    text: "Want to improve personal productivity and make smarter, data-driven decisions.",
  },
  {
    ...
    <section className="container rounded-xl py-20 bg-gradient-to-br from-[#1e3c72] via-[#2a5298] to-[#000000]">
      <div className="w-full mx-auto text-center px-4">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-white">
          This program is perfect if you want to master Excel and use it to
          solve real-world problems — no matter your background or experience.
          Even if you’re from a non-technical field, you can transform your
          career and gain in-demand skills.
        </p>
